...
class AdpPushClientModule extends ReactContextBaseJavaModule implements LifecycleEventListener {
    ...
    @ReactMethod
    public void login(String userId, ReadableArray channels) {
...
//    }
    ...
    @ReactMethod
    public void setDeferredDataListener(final boolean shouldLaunchDeeplink, final Promise promise) {
        if (chabok != null) {
